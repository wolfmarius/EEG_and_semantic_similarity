function [corr_all, auto_trial]=vectorized_sliding_after(data,data_vec,c_ind,n_bins,cat_sparse, code_groups, code_blocks)     
             ...
             trial_ind_tmp2 = [trial_ind2, code_blocks(trial_ind2)];             
              ...
              %  take care of same trial correlations
               ...
               %  take care of same block correlations in different categories (eliminates trials that where in the same rating block)      
                     if c1~=c2   
